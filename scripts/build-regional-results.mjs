  ...
  */
  ...
  async readTournament(get, info) {
    ...
    */
    ...
    if (info.entries) {
      /*
        ★★★**一覧が1校多い紙は、読み残しではなく「勝ち抜き表がその大会の全部ではない」**
        （2026-09-02 その2。**高知・愛媛・徳島の春季**）。

        紙の勝ち抜き表の**下に「順位決定戦」がある** ——
        四国大会へ進む枠を決める試合で、**日付と両校名だけが刷ってあり得点が無い。**

            高知2026春  表の決勝 高知商業 - 高知中央   ／ 順位決定戦 高知商業 - 高知農業（4/11）
                        一覧の優勝・準優勝は **高知商業・高知農業**（＝順位決定戦のほう）
            徳島2026春  表の決勝 海部 - 生光学園       ／ 順位決定戦 海部 - 阿南光（4/11）

        ★★**「一覧に余った1校」は、その順位決定戦に出る学校である。**
        ★**表の勝者を「優勝」と書けない**ので、**この紙は1試合も出さない**（今までどおり落とす）。
        ★**「末尾に余っているだけだから」と受けてはいけない** ——
        **画面に出る「決勝」が大会の決勝でなくなる。**
      */
