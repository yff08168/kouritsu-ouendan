...
export default function AboutPage() {
  return (
    ...
    >
      ...
      <h3>公立高校の野球を、もっと身近に。</h3>

      {/*
        イラストは実在の人物の写真ではない。
        「編集部」という運営名義に添える似顔絵として置いている。
        写真と誤認されないよう、alt でもイラストであることを示す。
      */}
      <Image
        src="/operator.png"
        alt="公立応援団 編集部のイラスト"
        width={240}
        height={320}
        className="float-right ml-4 mb-2 w-28 sm:w-36"
      />

      <p>高校野球を観戦することが好きな、ひとりの野球ファンです。</p>
      <p>
        高校野球を観戦していると、全国から選手が集まる強豪校だけではなく、
        地元の子どもたちが集まり、地域の中で日々練習を重ねている公立高校にも、
        特別な魅力があることに気づきます。
      </p>
      <p>
        もちろん、どの学校にもそれぞれの歴史や環境、そこにしかない魅力があります。
      </p>
      <p>
        その中でも私が公立高校に惹かれるのは、地元で育った選手たちが、
        仲間と力を合わせて強豪校に立ち向かっていく姿です。
      </p>
      <p>
        恵まれた環境や知名度だけではなく、一人ひとりが積み重ねてきた努力や、
        チームを支える家族、友人、地域の人たちの想い。
      </p>
      <p>
        そうしたものを背負って、大きな舞台で強豪校に挑む姿を見ると、
        なぜか自分自身の姿を重ねてしまうことがあります。
      </p>
      <p>「自分たちの身近な場所から、どこまで行けるのか。」</p>
      <p>そんな姿を見せてくれる公立高校の野球部を、私は応援しています。</p>
      <p>
        このサイトを始めたのも、もっと多くの人に、
        公立高校の魅力を知ってもらいたいと思ったことがきっかけです。
      </p>
      <p>
        学校の歴史や地域とのつながり、野球部のこれまでの歩み、
        そしてそこで野球に打ち込む選手たち。
      </p>
      <p>
        全国には、まだ知られていない魅力的な公立高校がたくさんあります。
      </p>
      <p>
        このサイトが、地元の高校を応援するきっかけになったり、
        「こんな学校があるんだ」と新しい高校との出会いにつながったりすれば
        嬉しく思います。
      </p>
      <p>強豪校だけが、高校野球じゃない。</p>
      <p>地元の仲間と積み重ねてきた日々が、いつか大きな舞台につながる。</p>
      <p>
        そんな公立高校の野球の魅力を、一人の高校野球ファンとして発信していきます。
      </p>
