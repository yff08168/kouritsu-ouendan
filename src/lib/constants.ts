...
export const SITE = {
  ...
  /*
    ★★**検索結果のタイトルに使う一文**（2026-09-06。運営者の判断）。

    ★**キャッチコピーとは役割が違う。** あちらは**ヒーローで読ませる言葉**で、
    **検索語をほとんど含まない**（「公立高校野球」だけ）。
    ドメインを取ったばかりで**「公立応援団」という名前で探す人がまだいない**うちは、
    トップの title は**何が載っているか**を書くほうが拾える。

    ★★**書けるのは実際に載っているものだけ** ——
    戦績（学校ページ）・地方大会の結果（県と大会のページ）・速報（`/live`）の3つ。
    **無いものを書かない**（`SITE.description` から「ニュース」を外したのと同じ線）。

    ★**キャッチコピーは消していない。** ヒーローの h1 は今までどおり。
  */
  searchTagline: "公立高校野球の戦績・地方大会の結果と速報",
  /*
    ★★**タイトルの区切りは全角「｜」でそろえる**（2026-09-06）。
    テンプレートが半角 ` | `、ページ側が全角「｜」で混ざっており、
    **1つのタイトルに2種類の区切りが出ていた**
    （`年別アーカイブ｜高校野球の記録を年でたどる | 公立応援団`）。
    ★**全角のほうが1〜2文字ぶん短い。** 日本語の検索結果は30文字ほどで切れるので、
    末尾のサイト名が落ちにくくなる。
  */
  titleSeparator: "｜",
  /*
    ★**「ニュース」は 2026-08-24 に外した**（運営者の判断。運用予定が無い）。
    **検索結果に出る文なので、まだ無いものを書かない。** 始めるときに戻す。
  */
  description:
    "全国の公立高校野球を応援する人のためのサイト。学校情報、戦績、歴史、そして公立旋風まで。公立高校野球の“今”を、ここに。",
  /*
...
export const NAV = [
  /*
    ★★**「地方大会」は 2026-08-28 に足した。先頭に置いてある。**

    春・夏・秋の大会期間中に**毎日見に来る人が最初に開くページ**で、
    サイトでいちばん動きのある場所（1日2回の自動更新）。
    それまで `/regional` も `/prefectures` もグローバルナビに無く、
    **トップから1クリックで進捗地図に行けなかった。**

    ★**「公立高校を探す」より前に置く理由**は、検索から来た人ではなく
    **ブックマークから来た人の導線**だから。**下げ戻さないこと。**
  */
  { href: "/regional", label: "地方大会" },
...
export const RANKINGS = [
  ...
  /*
    ★★**ここから下は地方大会から数えたもの**（2026-08-29 追加）。
    上の5件はすべて**甲子園の出場歴**（DB）から作っているが、
    地方大会は44,000試合あるのに横断して数えた場所が無かった。
    ★**数え方は `src/lib/records.ts`。** 出典は県ごとに違うので、
    ★**`DataNote`（甲子園の出典を名指ししている）をそのまま使わないこと。**
  */
  {
    slug: "regional-champions",
    title: "地方大会で優勝した公立高校",
    short: "地方大会の優勝",
    description:
      "春季大会・選手権予選・秋季大会で公立高校が優勝した大会の一覧。収録している全試合から数え上げ、大会ページへ辿れます。",
  },
  {
    slug: "rivalries",
    title: "よく当たるカード",
    short: "対戦の多い組",
    description:
      "同じ組み合わせが何度も実現した公立どうしの対戦を、多い順に。2校の全対戦を並べたページへ進めます。",
  },
] as const;
