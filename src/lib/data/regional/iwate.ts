...
// 出典: 白球ペンギン.com（https://89penguin.com/）

import type { RegionalDistrict } from "@/lib/regional-results";

export const REGIONAL_IWATE: RegionalDistrict = {
  "slug": "iwate",
  "district": "岩手",
