...
export const REGIONAL_LOADERS: Record<string, () => Promise<RegionalDistrict>> = {
  ...
  "aomori": () => import("./aomori.json").then((m) => m.default as RegionalDistrict),
  "miyagi": () => import("./miyagi.json").then((m) => m.default as RegionalDistrict),
  "akita": () => import("./akita.json").then((m) => m.default as RegionalDistrict),
  "tottori": () => import("./tottori.json").then((m) => m.default as RegionalDistrict),
  "kita-hokkaido": () => import("./kita-hokkaido.json").then((m) => m.default as RegionalDistrict),
