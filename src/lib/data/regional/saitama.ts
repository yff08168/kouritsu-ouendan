...
// 出典: 埼玉高校野球情報局（https://saitama-baseball.com/）

import type { RegionalDistrict } from "@/lib/regional-results";

export const REGIONAL_SAITAMA: RegionalDistrict = {
  "slug": "saitama",
  "district": "埼玉",
