...
--   ★**1試合ずつの勝ち上がりは入れていない。** 東京都高野連は
--   サイトの「データ」の転載を制限しており、地方大会の日別結果を
--   取れる出典がまだ無い（README「都道府県高野連サイトの規約調査」）。
--
-- 県相模原（神奈川）
